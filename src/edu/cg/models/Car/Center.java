...
public class Center implements IRenderable, IIntersectable {
	...
	public List<BoundingSphere> getBoundingSpheres() {
		...
		double r = Math.pow(Specification.C_LENGTH/2, 2) + Math.pow(Specification.C_HIEGHT/2, 2) + Math.pow(Specification.C_DEPTH/2, 2);
	    r = Math.sqrt(r);
        Point p = new Point(0, Specification.C_HIEGHT/2, 0);
